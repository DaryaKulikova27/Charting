...
package com.dasha.charting_lib.charting.charts;
...
import com.dasha.charting_lib.charting.components.XAxis;
import com.dasha.charting_lib.charting.data.PieData;
import com.dasha.charting_lib.charting.highlight.Highlight;
import com.dasha.charting_lib.charting.highlight.PieHighlighter;
import com.dasha.charting_lib.charting.interfaces.datasets.IPieDataSet;
import com.dasha.charting_lib.charting.renderer.PieChartRenderer;
import com.dasha.charting_lib.charting.renderer.WorkaroundPieChartRenderer;
import com.dasha.charting_lib.charting.utils.MPPointF;
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    protected void init() {
        ...
        mRenderer = new WorkaroundPieChartRenderer(this, mAnimator, mViewPortHandler);
        mXAxis = null;
    ...
    public void setHoleColor(int color) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((WorkaroundPieChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((WorkaroundPieChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof WorkaroundPieChartRenderer) {
            ((WorkaroundPieChartRenderer) mRenderer).releaseBitmap();
        }
