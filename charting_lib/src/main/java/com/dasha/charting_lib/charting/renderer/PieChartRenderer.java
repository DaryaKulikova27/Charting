...
import com.dasha.charting_lib.charting.charts.LineChart;
...
import com.dasha.charting_lib.charting.data.PieDataSet;
import com.dasha.charting_lib.charting.data.PieEntry;
...
public class PieChartRenderer extends DataRenderer {
    ...
    public void drawData(Canvas c) {
        ...
        Bitmap drawBitmap = mDrawBitmap == null ? null : mDrawBitmap;
        ...
        if (drawBitmap == null
            ...
            if (width > 0 && height > 0) {
                ...
                Log.d("TestTag", String.valueOf(mDrawBitmap));
